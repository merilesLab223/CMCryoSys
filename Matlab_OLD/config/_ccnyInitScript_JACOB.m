...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    handles.SignalGenerator = DummySignalGenerator();
...
handles.options.SpinNoiseDataFolder = 'C:\Users\cmeriles\Desktop\NV SOftware Daniela\wittelsbach control software 75 + phase\exp_data\Spin Noise data';
