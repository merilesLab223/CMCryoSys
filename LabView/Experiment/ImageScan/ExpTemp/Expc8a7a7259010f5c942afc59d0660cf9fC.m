...
classdef Expc8a7a7259010f5c942afc59d0660cf9fC < ExperimentCore
    ...
    methods
        ...
        function init(exp)
            ...
            if(~exp.HasBeenInitialized)
                exp.ExpInfo.addlistener('UpdateLoop',@exp.OnUpdateLoop);
            end
    ...
    methods (Access = protected)
        ...
        function initDevices(exp,niDevName)
            ...
            if(exp.SystemConfig.UseAnalogInputA0)
                exp.Devices.set('ni_counter','reader',NI6321AnalogReader(niDevName));
                exp.Reader.readchan='ai0';
            else
                exp.Devices.set('n_analog_input','reader',NI6321Counter(niDevName));
    ...
    methods(Access = protected)
        ...
        function OnStreamDataReady(exp,s,e)
            ...
            exp.StreamTrace=[0;exp.StreamTrace];
    ...
    methods(Access = private)
        ...
        function doScan(exp)
            ...
            WriteImageScan(exp.Pos,x0,y0,w,h,n,n,dwell,...
                'multidirectional',exp.ScanParameters.IsMultiDirectional);
